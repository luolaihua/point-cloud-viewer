...
PCLVisualizer::PCLVisualizer(QWidget* parent) : QMainWindow(parent), ui(new Ui::PCLVisualizer), point_size(1) {
    ui->setupUi(this);
...
void PCLVisualizer::initPointCloud() {
...
void PCLVisualizer::connectSS() {
    ...
    connect(ui->radioButton_x, &QRadioButton::clicked, this, &PCLVisualizer::chooseAxis);
    connect(ui->radioButton_y, &QRadioButton::clicked, this, &PCLVisualizer::chooseAxis);
    connect(ui->radioButton_z, &QRadioButton::clicked, this, &PCLVisualizer::chooseAxis);

    connect(ui->radioButton_BlueRed, &QRadioButton::clicked, this, &PCLVisualizer::chooseColorMode);
    connect(ui->radioButton_GreenMagenta, &QRadioButton::clicked, this, &PCLVisualizer::chooseColorMode);
...
void PCLVisualizer::IncPointSize() {
    viewer_->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, ++point_size);
...
void PCLVisualizer::DecPointSize() {
    if (point_size == 1)
        return;
    viewer_->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, --point_size);
    ui->label_pointSize->setText(QString::number(point_size));
